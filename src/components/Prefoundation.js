...
import PrefoundationImage from "../assets/prefoundation/prefoundationimage.png";
import PrefoundationVideo from "../assets/prefoundation/prefoundationvideo.png";
import Left from "../assets/prefoundation/left.png";
import Right from "../assets/prefoundation/right.png";
import Square from "../assets/prefoundation/squaretick.png";
import Circle from "../assets/prefoundation/circletick.png";
import PrefoundationLaptop from "../assets/prefoundation/prefoundationlaptop.png";
import { Link } from "react-router-dom";
import gButton from "../assets/gbutton.png";
import Try from "../assets/prefoundation/try.png";
...
const Cmp = () => {
  ...
  const [mathButtonColor, setMathButtonColor] = useState("#0D3E64");
    ...
    <div>
      <div className="bg-white relative sm:h-[720px]  lg:h-[500px]">
        ...
        <div
          ...
          style={{ backgroundColor: "#64839C", opacity: 0.8 }}
        ></div>

        <div className=" relative text-center">
          <h1
            className="font-bold sm:text-2xl md:text-3xl lg:text-3xl lg:mt-5"
            style={{ color: "#266CA2" }}
          >
          ...
          <div className="text-left">
            ...
            <div className="lg:w-[600px] sm:mt-[400px] lg:mt-4">
              <p className="font-semibold lg:text-2xl sm:text-center lg:text-left sm:text-sm md:text-lg">
                Alamkul's Prefoundation courses are designed for students of
                class 8, 9 and 10 to lay the foundation for JEE/NEET
                preparation.JEE/NEET preparation is time-consuming and requires
                a lot of patience.
              </p>
            </div>
        ...
        <img
          src={PrefoundationImage}
          alt=""
          className="lg:w-2/6 lg:absolute lg:right-0 lg:top-[68px] sm:mt-[-470px] md:mt-[-480px] sm:mx-auto  lg:mt-0 sm:w-[280px] md:w-[300px]"
        />

        <img
          src={PrefoundationVideo}
          alt=""
          className=" sm:w-[70px] sm:mt-[-350px] md:mt-[-365px] sm:mx-auto lg:mt-0 lg:w-[110px] lg:absolute lg:right-0 lg:top-20 lg:mr-[430px] cursor-pointer"
          onClick={videoOpen}
        />
      </div>
      <div
        className=" lg:h-[800px] mt-[46px] lg:flex lg:justify-center lg:items-center"
        style={{ backgroundColor: "#094573", opacity: 0.7 }}
      >
        <div
          ...
          >
            ...
            <div className="text-center">
              <p
                ...
                style={{ color: "#0D3E64" }}
              >
                This course will help students to have a better understanding of
                the basic concept in simple and comprehensive manner.
              </p>
            </div>
        ...
        >
          ...
          >
            <div className="flex lg:mr-[55px] md:ml-[-25px] sm:mr-[50px] sm:mt-20 md:mt-4 lg:mt-0">
              ...
              >
                Elite <br />
                <span className="text-xs">6K/month</span>
              </button>
              <button
              ...
              >
                Basic <br />
                <span className="text-xs">2K/month</span>
              </button>
            </div>
      ...
      <div className="bg-white lg:h-[800px] ">
        <img
          src={PrefoundationLaptop}
          alt=""
          className="w-[900px] mx-auto mt-6"
        />
      </div>
      <div
        id="form-section"
              ...
              <div class="">
                ...
                <div>
                  <input
                    ...
                    style={{ backgroundColor: "#3A6A8F", opacity: 0.6 }}
                  />
                </div>
              </div>
              <div class="mt-4">
