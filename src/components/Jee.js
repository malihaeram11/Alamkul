...
import JeeImage from "../assets/jee/jeeimage.png";
import JeeVideo from "../assets/jee/jeevideo.png";
import Left from "../assets/jee/left.png";
import Right from "../assets/jee/right.png";
import Square from "../assets/jee/squaretick.png";
import Circle from "../assets/jee/circletick.png";
import JeeLaptop from "../assets/jee/jeelaptop.png";
import { Link } from "react-router-dom";
import gButton from "../assets/gbutton.png";
import Try from "../assets/jee/try.png";
...
const Jee = () => {
  ...
  const [mathButtonColor, setMathButtonColor] = useState("#7C9908");
    ...
    <div>
      <div className="bg-white relative sm:h-[720px]  lg:h-[500px]">
        ...
        <div
          ...
          style={{ backgroundColor: "#7C9908", opacity: 0.8 }}
        ></div>

        <div className=" relative text-center">
          <h1 className="font-bold sm:text-2xl md:text-3xl lg:text-3xl lg:mt-5 text-black">
            Foundation Course : <span style={{ color: "#829F0D" }}>JEE</span>
          </h1>
          ...
          <div className="text-left">
            ...
            <div className="lg:w-[600px] sm:mt-[400px] lg:mt-4">
              <p className="font-semibold lg:text-2xl sm:text-center lg:text-left sm:text-sm md:text-lg">
                Alamkul's foundation courses is specially designed as per the
                latest examination pattern for students of class 11 and 12
                wanting to simultaneously excel in engineering entrance exam as
                well as School/Board Exams
              </p>
            </div>
        ...
        <img
          src={JeeImage}
          alt=""
          className="lg:w-2/6 lg:absolute lg:right-0 lg:top-[-37px] sm:mt-[-470px] md:mt-[-480px] sm:mx-auto  lg:mt-0 sm:w-[240px] md:w-[250px]"
        />

        <img
          src={JeeVideo}
          alt=""
          className=" sm:w-[70px] sm:mt-[-350px] md:mt-[-355px] sm:mx-auto lg:mt-0 lg:w-[110px] lg:absolute lg:right-0 lg:top-20 lg:mr-[430px] cursor-pointer"
          onClick={videoOpen}
        />
      </div>
      <div
        className=" lg:h-[800px] mt-[26px] lg:flex lg:justify-center lg:items-center"
        style={{ backgroundColor: "#96AD39" }}
      >
        <div
      ...
      <div className="bg-white lg:h-[800px] ">
        <img src={JeeLaptop} alt="" className="w-[900px] mx-auto mt-6" />
      </div>
      <div
        id="form-section"
              ...
              <div class="">
                ...
                <div>
                  <input
                    ...
                    style={{ backgroundColor: "#96AD39", opacity: 0.6 }}
                  />
                </div>
              </div>
              <div class="mt-4">
        ...
        <div className="sm:my-[100px] sm:text-center  lg:text-left  lg:my-[200px] lg:mx-auto lg:w-[500px]">
          <div className="font-semibold text-xl ">
            ...
            <div className="mb-4">
              ...
              >
                What is the age criterion for appearing in JEE?
              </p>
              <div
            ...
            <div className="mb-4">
              <p
                ...
                style={{
                  maxHeight: showTwoStory ? "100px" : "70px",
                  overflow: "hidden",
                  transition: "max-height 0.3s ease",
                }}
              >
                When will the application window to apply for JEE (Main)-2023 be
                available?
              </p>
              <div
                className="lg:text-lg sm:text-sm  md:text-xl overflow-hidden text-blue-800"
                style={{
                  maxHeight: showTwoStory ? "170px" : 0,
                  opacity: showTwoStory ? 1 : 0,
                  transition: "max-height 0.3s ease, opacity 0.3s ease",
                }}
              >
                The application window to apply for JEE (Main)- 2023 is
                available between 16.12.2023 (Wednesday) to 16.01.2023
                (Saturday). The fees can be paid online upto 17.01.2023
                (Sunday). The application window will be opened again for a
                brief period of 3-4 days after announcement of results of each
                session.
              </div>
            </div>
            <div className="mb-4">
              ...
              >
                In how many Sessions will JEE (Main)-2023 be conducted?
              </p>
              <div
                className="lg:text-lg sm:text-sm  md:text-xl overflow-hidden text-blue-800"
                style={{
              ...
              >
                JEE (Main)-2023 will be conducted in Four Sessions (February/
                March/ April/ May).
              </div>
            </div>
          </div>
